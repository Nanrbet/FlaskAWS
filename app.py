...
async def home(request: Request):
    ...
    try:
        ...
        return templates.TemplateResponse("index.html", {"request": request, "balances": [{'currency': 'CAD', 'balance': '***'}, {'currency': 'USDC', 'balance': '***'}, {'currency': 'BTC', 'balance': '***'}]})
...
async def webhook(request: Request):
    ...
    try:
        ...
        return JSONResponse({"status": "success", "message": f"Processed {action} order for {ticker}"})
    except Exception as e:
